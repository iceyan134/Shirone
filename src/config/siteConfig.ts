...
export const siteConfig: SiteConfig = withUserConfig("site", {
	site: "https://blog.173469.xyz/",
	base: "/",
	title: "霜折",
	subtitle: "在霜色与月光里记录日常、技术与灵感",
	...
	themeColor: {
		hue: 235, // Default hue 0-360. 站点设计默认粉紫（偏二次元）；262 紫 / 345 粉 也可选
	...
	texture: {
		...
		defaultOpacity: 0.08, // 默认纹理浓度 (0.05 ~ 0.25)
	...
	banner: {
		...
		src: {
			desktop: ["assets/images/banner/desktop/shuangzhe-hero.png"],
			mobile: ["assets/images/banner/mobile/shuangzhe-hero.png"],
		},
